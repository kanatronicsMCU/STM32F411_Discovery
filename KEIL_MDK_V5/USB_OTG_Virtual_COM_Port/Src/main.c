...
/**
  ...
  *                             www.st.com/SLA0044
  * STM32F411 Discovery OTG Virtual COM Port demo 115200bps
	* K.Kanas 22/8/2018
  ******************************************************************************
  */
...
uint8_t buffer[100]=" Virtual COM Port Demo Press any key\r\n";
...
/* USER CODE BEGIN 4 */
void CDC_ReceiveCallback (uint8_t *buf,uint32_t len) /*Callback for receiving USB buffer*/
